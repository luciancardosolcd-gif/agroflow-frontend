        ...
        <div className="rounded-2xl border border-blue-500/20 bg-blue-500/3 p-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl p-3 border border-orange-500/20 bg-orange-500/5 flex items-center gap-3">
              ...
              <div><p className="text-xs text-gray-400">Temperatura</p><p className="text-lg font-bold text-orange-400">{clima.temperatura}°C</p></div>
            </div>
            <div className="rounded-xl p-3 border border-blue-500/20 bg-blue-500/5 flex items-center gap-3">
              ...
              <div><p className="text-xs text-gray-400">Umidade</p><p className="text-lg font-bold text-blue-400">{clima.umidade}%</p></div>
            </div>
            <div className="rounded-xl p-3 border border-cyan-500/20 bg-cyan-500/5 flex items-center gap-3">
              ...
              <div><p className="text-xs text-gray-400">Vento</p><p className="text-lg font-bold text-cyan-400">{clima.vento} km/h</p></div>
            </div>
            <div className="rounded-xl p-3 border border-indigo-500/20 bg-indigo-500/5 flex items-center gap-3">
              ...
              <div><p className="text-xs text-gray-400">Chuva</p><p className="text-lg font-bold text-indigo-400">{clima.chuva} mm</p></div>
            </div>
          </div>
