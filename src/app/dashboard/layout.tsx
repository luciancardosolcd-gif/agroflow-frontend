...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* ── Header ── */}
      <header className="h-16 bg-[#0d160d] border-b border-[#1a251a] flex items-center justify-between px-6 flex-shrink-0 sticky top-0 z-30">
      ...
      {/* ── Conteúdo ── */}
      <main className="flex-1 p-6 overflow-auto bg-[#0a0f0a]">
        {children}
      </main>
