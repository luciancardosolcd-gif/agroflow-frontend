      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-neutral-900 border-b border-neutral-800 flex items-center justify-between px-6 flex-shrink-0">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-3 bg-neutral-800 rounded-lg px-4 py-2 w-56">
          ...
          <div className="flex items-center gap-4">
            <button className="relative w-9 h-9 bg-neutral-800 rounded-lg flex items-center justify-center text-green-600 hover:text-green-400 border border-neutral-700">
